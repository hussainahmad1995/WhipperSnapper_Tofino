...
p4 = bfrt.remove_headers_main.pipe.Ingress
...
test_table.add_with_remove_headers(dst_addr=IPAddress("10.0.0.3"))
test_table.add_with_remove_headers(dst_addr=IPAddress("10.0.0.23"))
