...
class timestamp(Packet):
    ...
    fields_desc = [
        ...
        XBitField(name = 'version', default = "0x1" , size = 16 , tot_size = 16 )
    ]
...
class headers(Packet):
    name = "Custom header"
    fields_desc = [XBitField (name = 'field_0', default = "0x1" , size = 16 , tot_size = 16)]

bind_layers(timestamp , headers , version = "0x1" )
...
if __name__ == "__main__":
    ...
    pkt = Ether(src = src_mac_addr , dst = dst_mac_addr , type = 0x0800)  \
        ...
        / timestamp(time_value = 0, version = 1) \
        / headers(field_0 = 1) \
        / headers(field_0 = 1) \
        / headers(field_0 = 1) \
        / headers(field_0 = 1) \
